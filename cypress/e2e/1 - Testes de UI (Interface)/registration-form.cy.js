describe('Formulário de Cadastro de Usuário', () => {
  beforeEach(() => {
    // Navega até a página do formulário antes de cada teste
  ...
  it('Deve exibir mensagem de sucesso ao preencher o formulário corretamente', () => {
    cy.get('#nome').type('Usuário Guia de Motéis'); // Campo Nome
    cy.get('#email').type('usuario@guia-de-moteis.com'); // Campo E-mail
    cy.get('#confirmacaoEmail').type('usuario@guia-de-moteis.com'); // Campo Confirmação de E-mail
  ...
  it('Deve exibir erro ao digitar uma senha fraca', () => {
    cy.get('#nome').type('Usuário Guia de Motéis');
    cy.get('#email').type('usuario@guia-de-moteis.com');
    cy.get('#confirmacaoEmail').type('usuario@guia-de-moteis.com');
  ...
  it('Deve exibir erro ao digitar e-mails diferentes nos campos de confirmação', () => {
    cy.get('#nome').type('Usuário Guia de Motéis');
    cy.get('#email').type('usuario@guia-de-moteis.com');
    cy.get('#confirmacaoEmail').type('diferente@guia-de-moteis.com'); // E-mails diferentes
